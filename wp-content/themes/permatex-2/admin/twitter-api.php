   ...
   // Your Twitter App Consumer Key
	...
	private function getTwitterJSON() {
		...
		$tmhOAuth = new tmhOAuth(array(
			...
			'consumer_key'          => wf_theme_get_option('twitter_consumer_key'),
			'consumer_secret'       => wf_theme_get_option('twitter_consumer_secret'),
			'user_token'            => wf_theme_get_option('twitter_user_token'),
			'user_secret'           => wf_theme_get_option('twitter_user_secret'),
