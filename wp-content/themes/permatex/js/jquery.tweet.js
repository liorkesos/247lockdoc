	...
	$.fn.tweet = function(o){
		...
		$.fn.extend({
			...
			linkHash: replacer(/(?:^| )[\#]+([\w\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u00ff\u0600-\u06ff]+)/gi,
				' <a href="http://'+s.twitter_search_url+'/search?q=%23$1&src=hash'+((s.username && s.username.length == 1 && !s.list) ? '&from='+s.username.join("%2BOR%2B") : '')+'" class="tweet_hashtag">#$1</a>'),
		...
		return this.each(function(i, widget){
          ...
          if(data.response.errors && data.response.errors.length) {
            return false;
          }
